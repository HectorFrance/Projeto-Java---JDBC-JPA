...
public class BuscarImp extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BuscarImp frame = new BuscarImp();
					frame.setTitle("Impressoras");
	...
	public BuscarImp() {
		...
		DefaultTableModel modelo = new DefaultTableModel(new Object[][] {},
				new String[] { "Cod", "Cod_Fab", "Modelo", "Preco", "Tipo" });
		...
		modelo.setNumRows(0);
		modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "Preco", "Tipo" });
		for (Impressora i : c.IMPlistarTudo()) {
			modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getPreco(), i.getTipo() });
		}
		...
		btn_preco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_preco.getText().equalsIgnoreCase("")) {
					...
					for (Impressora i : c.IMPlistarTudo()) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getPreco(), i.getTipo() });
					}
				} else {
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "Preco", "Tipo" });
					for (Impressora i : c.pesquisaPreco(Integer.parseInt(textField_preco.getText()))) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getPreco(), i.getTipo() });
					}
				}
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				c.removerIMP(Integer.parseInt(txtCodigo.getText()));
				modelo.setNumRows(0);
				modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "Preco", "Tipo" });
				for (Impressora i : c.IMPlistarTudo()) {
					modelo.addRow(
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new AltIMP().setVisible(true);
			}
		});
		btnAlterar.setBounds(557, 49, 89, 23);
		contentPane.add(btnAlterar);

		JButton btnFAB = new JButton("Buscar");
		btnFAB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_fab.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "Preco", "Tipo" });
					for (Impressora i : c.pesquisaCodFab(Integer.parseInt(textField_fab.getText()))) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getPreco(), i.getTipo() });
					}
				}
		...
		btnFAB.setBounds(168, 97, 89, 23);
		contentPane.add(btnFAB);
		...
		btnModelo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textFieldModelo.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "Preco", "Tipo" });
					for (Impressora i : c.IMP_pesquisaModelo(textFieldModelo.getText())) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getPreco(), i.getTipo() });
					}
				}
