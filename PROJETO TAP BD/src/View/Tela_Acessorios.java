...
public class Tela_Acessorios extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tela_Acessorios frame = new Tela_Acessorios();
	...
	public Tela_Acessorios() {
		...
		DefaultTableModel modelo = new DefaultTableModel(new Object[][] {},
				new String[] { "Cod", "Cod_Fab", "Tipo", "Modelo", "preco" });
		...
		modelo.setNumRows(0);
		modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Tipo", "Modelo", "preco" });
		for (Acessorios i : c.AC_listarTudo()) {
			modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getTipo(), i.getModelo(), i.getPreco() });
		}
		...
		btn_preco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_preco.getText().equalsIgnoreCase("")) {
					...
					for (Acessorios i : c.AC_listarTudo()) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getTipo(), i.getModelo(), i.getPreco() });
					}
				} else {
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Tipo", "Modelo", "preco" });
					for (Acessorios i : c.AC_pesquisaPreco(Integer.parseInt(textField_preco.getText()))) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getTipo(), i.getModelo(), i.getPreco() });
					}
				}
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				c.AC_remover(Integer.parseInt(txtCodigo.getText()));
				modelo.setNumRows(0);
				modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Tipo", "Modelo", "preco" });
				for (Acessorios i : c.AC_listarTudo()) {
					modelo.addRow(
		...
		btn_fab.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_fab.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Tipo", "Modelo", "preco" });
					for (Acessorios i : c.AC_pesquisaCodFab(Integer.parseInt(textField_fab.getText()))) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getTipo(), i.getModelo(), i.getPreco() });
					}
				}
		...
		btnModelo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textFieldModelo.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Tipo", "Modelo", "preco" });
					for (Acessorios i : c.AC_pesquisaModelo(textFieldModelo.getText())) {
						modelo.addRow(
								new Object[] { i.getCod(), i.getCod_fab(), i.getTipo(), i.getModelo(), i.getPreco() });
					}
				}
