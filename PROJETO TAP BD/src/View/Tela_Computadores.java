...
public class Tela_Computadores extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tela_Computadores frame = new Tela_Computadores();
					frame.setTitle("Computadores");
	...
	public Tela_Computadores() {
		...
		DefaultTableModel modelo = new DefaultTableModel(new Object[][] {},
				new String[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
		...
		modelo.setNumRows(0);
		modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
		for (Computadores i : c.COMP_listarTudo()) {
			modelo.addRow(
					new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getRAM(), i.getHD(), i.getPreco() });
		}
		...
		btn_preco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_preco.getText().equalsIgnoreCase("")) {
					...
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
					for (Computadores i : c.COMP_listarTudo()) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getRAM(), i.getHD(),
								i.getPreco() });
					}
				} else {
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
					for (Computadores i : c.COMP_pesquisaPreco(Integer.parseInt(textField_preco.getText()))) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getRAM(), i.getHD(),
								i.getPreco() });
					}
				}
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				c.COMP_remover(Integer.parseInt(txtCodigo.getText()));
				modelo.setNumRows(0);
				modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
				for (Computadores i : c.COMP_listarTudo()) {
					modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getRAM(), i.getHD(),
		...
		btn_fab.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_fab.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
					for (Computadores i : c.COMP_pesquisaCodFab(Integer.parseInt(textField_fab.getText()))) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getRAM(), i.getHD(),
								i.getPreco() });
					}
				}
		...
		btnModelo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textFieldModelo.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod_Fab", "Modelo", "RAM", "HD", "preco" });
					for (Computadores i : c.COMP_pesquisaModelo(textFieldModelo.getText())) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_fab(), i.getModelo(), i.getRAM(), i.getHD(),
								i.getPreco() });
					}
				}
