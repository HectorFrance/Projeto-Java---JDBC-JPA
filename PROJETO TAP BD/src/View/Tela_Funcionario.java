...
public class Tela_Funcionario extends JFrame {
	...
	public Tela_Funcionario() {
		...
		DefaultTableModel modelo = new DefaultTableModel(new Object[][] {},
				new String[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
		...
		modelo.setNumRows(0);
		modelo.addRow(new Object[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
		for (Funcionario i : c.FUNC_ListarTudo()) {
		...
		btn_preco.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_NOME.getText().equalsIgnoreCase("")) {
					...
					modelo.addRow(new Object[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
					for (Funcionario i : c.FUNC_ListarTudo()) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_end(), i.getCpf(), i.getNome(),
								i.getTelefone(), i.getSetor() });
					}
				} else {
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
					for (Funcionario i : c.FUNC_pesquisaNome(textField_NOME.getText())) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_end(), i.getCpf(), i.getNome(),
								i.getTelefone(), i.getSetor() });
					}
				}
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				c.FUNC_remover(Integer.parseInt(txtCodigo.getText()));
				modelo.setNumRows(0);
				modelo.addRow(new Object[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
				for (Funcionario i : c.FUNC_ListarTudo()) {
					modelo.addRow(new Object[] { i.getCod(), i.getCod_end(), i.getCpf(), i.getNome(), i.getTelefone(),
		...
		btn_fab.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_CPF.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
					for (Funcionario i : c.FUNC_pesquisaCpf(textField_CPF.getText())) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_end(), i.getCpf(), i.getNome(),
								i.getTelefone(), i.getSetor() });
					}
				}
		...
		btnModelo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textFieldTELEFONE.getText().equalsIgnoreCase("")) {
					...
					modelo.setNumRows(0);
					modelo.addRow(new Object[] { "Cod", "Cod End", "Cpf", "Nome", "Telefone", "Setor" });
					for (Funcionario i : c.FUNC_pesquisaSetor(textFieldTELEFONE.getText())) {
						modelo.addRow(new Object[] { i.getCod(), i.getCod_end(), i.getCpf(), i.getNome(),
								i.getTelefone(), i.getSetor() });
					}
				}
